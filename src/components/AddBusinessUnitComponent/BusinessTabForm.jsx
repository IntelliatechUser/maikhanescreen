    ...
    <div className="mt-15 mr-7 ">
      ...
      <div className="grid grid-cols-[66%_34%] gap-6   ">
        <div>
          ...
          <div className="grid grid-cols-[77%_33%]  mb-6 ">
            <div>
              <input
                type="text"
                className="w-full p-3 border border-customOrange outline-none rounded"
          ...
          {selectedIdType && (
            <div className="grid grid-cols-2 gap-6 mb-6 ">
              {selectedIdType !== "PAN" && selectedIdType !== "select" && (
                <div className="grid grid-cols-[60%_40%] ">
                  ...
                  />
                  <button className="ml-2 border border-customOrange text-[#FF9F08] py-2 px-4 rounded-md border-dashed">
                    Upload
                  </button>
                </div>
              )}
              {selectedIdType !== "GST" && selectedIdType !== "select" && (
                <div className="grid grid-cols-[60%_40%] ">
                  <input
                    type="text"
                    className="w-full p-3 border border-customOrange outline-none rounded"
              ...
              {selectedIdType !== "CIN" && selectedIdType !== "select" && (
                <div className="grid grid-cols-[60%_40%] ">
                  <input
                    type="text"
                    className="w-full p-3 border border-customOrange outline-none rounded"
