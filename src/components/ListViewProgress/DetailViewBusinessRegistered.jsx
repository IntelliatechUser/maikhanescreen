...
const DetailViewBusinessRegistered = () => {
  const { id } = useParams();
  const { listBusinessRegistered } = businessStatus();
  const navigate = useNavigate();
  // Find the business detail with the matching id
  const businessDetail = listBusinessRegistered?.find(item => item.id === parseInt(id));
...
export default DetailViewBusinessRegistered;
