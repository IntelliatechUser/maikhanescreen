        ...
        <div className="flex-col w-full ">
          ...
          <div className="flex-col  w-[65%]">
            ...
            <Select
              ...
              variant="default"
              size="default"
              className="mb-[15px] py-2 z-10"
              LeftIcon={<IconAwesomeuser/>}
              rightIcon={<ArrowPreviewSmall color="#0F0F0F"/>}

            />
            <InputField size="default" className="mb-[40px] mt-5 " Icon={<IconAwesomephone/>} placeholder="Enter OTP"/>
            <div className="flex justify-end ">
              <Button className={"w-[30%]"} onClick={()=>{navigate("/dashboard")}}>
